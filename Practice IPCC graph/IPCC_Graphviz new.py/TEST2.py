...
#Creates Working Groups [Wg1, Wg2, Wg3] and Synthesis Report Node [SynR]
...
for node in Wg1_Ch:     #For Iterating the Properties of Chapters [Ch1_1-Ch1_12] & Atlas of Working Group 1 [Wg1]
    ...
    graph.edge('Wg1', node, style="dotted")  #Connects Edge Chapters and Atlas to Working Group 1
...
for node in SubcategoryWg2:    #For Iterating the Properties of SubCategory of Working Group 2
    ...
    graph.edge('Wg2', node, style="dotted")   #Connects Edge Subcategory to Working Group 2
