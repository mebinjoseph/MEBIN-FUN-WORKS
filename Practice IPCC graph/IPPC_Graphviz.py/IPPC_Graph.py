...
for node in Wg:          #For iterating the properties and URL of Working Groups 1-3
    if node == "Wg1":
...
for node in SynR:           #For iterating the properties and URL of Synthesis Report
    if node == 'SynR':
...
for node in SubcategoryWg2:                     #For iterating the properties of Chapter & Cross_Chapters for Working Group 2
...
for node in Wg2_Ch:                             #For iterating the properties and URL of Chapters of Working Group 2
    if node=='Ch2_1':
...
for node in Wg2_Ccp:                    #For iterating the properties and URL of Cross-Chapters of Working Group 2
    if node=='Ccp1':
...
for node in Wg3_Ch:                     #For iterating the properties and URL of Chapters of Working Group 3
    if node=='Ch3_1':
